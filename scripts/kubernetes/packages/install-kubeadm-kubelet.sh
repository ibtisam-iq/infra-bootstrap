...
#
# Purpose:
#   - Worker node Kubernetes components
#   - kubelet + kubeadm only
#
# Notes:
#   - kubectl is NOT installed here
#   - Uses official pkgs.k8s.io repository
# ==================================================
...
: "${K8S_VERSION:?K8S_VERSION is required (e.g. 1.30.1)}"
...
ok "Kubernetes node components installed"
